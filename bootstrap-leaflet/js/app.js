...
function sidebarClick(id) {
  var layer = accessLayer.getLayer(id);
...
var accessLayer = L.esri.featureLayer({
    ...
    if (feature.properties) {
      ...
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.pointName+'&nbsp;&nbsp<img width="20" height="20" src="icons/'+getType(layer.feature.properties.pointType)[1]+'">');
          $("#feature-info").html(content);
          $("#featureModal").modal("show");
          highlight.clearLayers().addLayer(L.circleMarker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], highlightStyle));
        }
      });
      $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="20" height="20" src="icons/'+getType(layer.feature.properties.pointType)[1]+'"></td><td class="feature-name">' + layer.feature.properties.pointName + '</td><td class="feature-name">' + layer.feature.properties.streamMile + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      accessSearch.push({
